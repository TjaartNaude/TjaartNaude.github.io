<template>
    <div class="q-pa-md">
        <div class="q-gutter-y-sm" style="margin-left: 15px; margin-right: 15px;">
            <div class="row">
                <div class="col-flex">
                    <q-btn class="q-mt-md" @click="$router.push('/settings')" label="Back" icon="arrow_back_ios"
                        color="secondary" outline=""></q-btn>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <q-card class=" q-ma-lg">
                        <q-tabs v-model="tab" class="text-white bg-secondary " indicator-color="white" :align="'justify'"
                            narrow-indicator>
                ...
                -->
                        <q-tab-panels v-model="tab" animated :align="'center'">
                            <q-tab-panel name="categories">
                                <div class="q-pa-md">
                                    <!-- Categries Table -->
                                    <q-table title="Category Types" :key="tableKey" color="secondary" virtual-scroll
                                        :align="left" :loading="loading" :rows="categoryData" :columns="catColumns"
                                        :virtual-scroll-sticky-size-start="20" :visible-columns="visibleCategoryColumns">
                                        ...
                                        <template v-slot:body-cell-actions="props">
                                            <q-td :props="props">
                                                <q-btn dense round flat color="secondary"
                                                    @click="editRow('Category', props)" icon="edit">
                                                </q-btn>
                                            </q-td>
                                        </template>
                                        <template v-slot:body-cell-delactions="props">
                                            <q-td :props="props">
                                                <q-btn dense round flat @click="deleteRow('Category', props)" icon="delete"
                    ...
                    -->
                            <q-tab-panel v-model="tab" animated :align="'center'" name="priorities">
                                <div class="q-pa-md"><!-- Priorities Table -->
                                    <q-table title="Prioirities" :key="tableKey" color="secondary" virtual-scroll
                                        :align="left" :loading="loading" :rows="categoryData" :columns="catColumns"
                                        :virtual-scroll-sticky-size-start="20" :visible-columns="visibleCategoryColumns">
                                        <template #body-cell-status="props">
                                            <q-td :props="props">
                                        ...
                                        <template v-slot:body-cell-delactions="props">
                                            <q-td :props="props">
                                                <q-btn dense round flat @click="deleteRow('Priority', props)" icon="delete"
                                                    color="secondary"></q-btn>
                                            </q-td>
                                        </template>
                                    </q-table>
            ...
            <template v-if="editedItem.showDialog">
                <EditSettingDialog :id="editedItem.itemId" :name="editedItem.itemName" :isActive="editedItem.isItemActive"
                    :type="editedItem.itemType" @close-dialog="handleCloseDialog" @save-dialog="handleSaveDialog" />
            </template>

            <!-- Delete Settings Dialog -->
            <template v-if="deleteItem.showDialog">
                <DeleteSettingsDialog :id="deleteItem.itemId" :name="deleteItem.itemName" :type="deleteItem.itemType"
                    @close-dialog="handleCloseDeleteDialog" @delete-dialog="handleDeleteDialog" />
            </template>
        </div>
    </div>
</template>
